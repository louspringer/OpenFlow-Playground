...
class DomainInfo(BaseModel):
    ...
    extraction_candidate: Union[bool, str] = Field(False, description="Extraction candidate flag (bool or priority string)")
...
class ProjectModel(BaseModel):
    ...
    project_purpose: Union[str, Dict[str, Any]] = Field(..., description="Project purpose (string or dict)")
    domain_architecture: Dict[str, CategoryInfo] = Field(default_factory=dict, description="Domain architecture")
    domains: Dict[str, Optional[DomainInfo]] = Field(default_factory=dict, description="Domain definitions")
