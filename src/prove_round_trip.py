...
def prove_round_trip() -> dict[str, Any]:
    ...
    for name in original_names:
        ...
        assert original.description == loaded.description, f"Component description mismatch: {name}"
        assert original.requirements == loaded.requirements, f"Component requirements mismatch: {name}"
        assert original.dependencies == loaded.dependencies, f"Component dependencies mismatch: {name}"
