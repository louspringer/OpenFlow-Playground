...
OpenFlow Security First Package
...
```bash
pip install openflow-security-first
```

## Development Installation

```bash
git clone https://github.com/openflow/openflow-security-first.git
cd openflow-security-first
pip install -e .
```
...
```python
from openflow-security-first import main
