...
OpenFlow Ghostbusters Package

## Package Potential Score: 10/10
...
```bash
pip install openflow-ghostbusters
```

## Development Installation

```bash
git clone https://github.com/openflow/openflow-ghostbusters.git
cd openflow-ghostbusters
pip install -e .
```
...
```python
from openflow-ghostbusters import main
