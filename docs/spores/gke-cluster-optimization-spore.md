...
2. **ImagePullBackOff**: One kiro-agent pod already failing
3. **Preemptible Interruption**: Nodes can be terminated

### **Mitigation Strategies**
1. **Gradual Scaling**: Scale down default pool first, then up preemptible
2. **Pod Disruption Budgets**: Ensure critical pods can handle eviction
3. **Health Checks**: Monitor pod health during migration
