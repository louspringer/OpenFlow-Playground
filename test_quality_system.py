...
def test_quality_metrics():
    ...
    try:
        from code_quality_system.quality_metrics import (
            QualityMetrics,
...
def test_quality_gates():
    ...
    try:
        from code_quality_system.quality_gates import (
            GateSeverity,
            QualityGate,
            QualityGateManager,
        )
...
def test_pre_commit_integration():
    ...
    try:
        from code_quality_system.integrations.pre_commit_integration import (
